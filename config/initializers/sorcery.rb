...
Rails.application.config.sorcery.submodules = [:remember_me, :reset_password, :external, :brute_force_protection]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    # Default: `nil`
    #
    user.reset_password_mailer = BaseMailer


    # reset password email method on your mailer class.
    # Default: `:reset_password_email`
    #
    user.reset_password_email_method_name = :user_resets_password
    ...
    # Default: `60 * 60`
    #
    user.login_lock_time_period = 1 * 60
